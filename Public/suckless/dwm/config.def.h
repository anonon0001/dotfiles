...
static const char col_gray3[]       = "#77aa99";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_e,      view,           {.ui = ~0 } },
	{ MODKEY|ShiftMask,             XK_e,      tag,            {.ui = ~0 } },
	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } },
	{ MODKEY,                       XK_period, focusmon,       {.i = +1 } },
	{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } },
	{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } },
    TAGKEYS( XK_ampersand,          0) // Tag 1: &
    TAGKEYS( XK_eacute,             1) // Tag 2: é
    TAGKEYS( XK_quotedbl,           2) // Tag 3: "
    TAGKEYS( XK_apostrophe,         3) // Tag 4: '
    TAGKEYS( XK_parenleft,          4) // Tag 5: (
    TAGKEYS( XK_minus,              5) // Tag 6: -
    TAGKEYS( XK_egrave,             6) // Tag 7: è
    TAGKEYS( XK_underscore,         7) // Tag 8: _
    TAGKEYS( XK_ccedilla,           8) // Tag 9: ç
    TAGKEYS( XK_agrave,             9) // Tag 10: à
